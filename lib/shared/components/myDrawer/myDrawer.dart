import 'package:agriculture/modules/aboutUsScreen/aboutUs.dart';
import 'package:agriculture/modules/contactUsScreen/contactUs.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          //     index: 3),
          menuItem(context, Icons.phone, 'تواصل معنا', ContactUsScreen(),
              index: 2),
...
// Build menu of Drawer
  Widget menuItem(context, IconData icon, String text, Widget widget,
    ...
    return Material(
      child: InkWell(
        onTap: () {
          AppCubit.get(context).getAboutData();
